# Generated by Django 2.1.8 on 2019-07-22 05:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ShopApp.Goods', verbose_name='商品id')),
            ],
        ),
        migrations.CreateModel(
            name='Seller',
            fields=[
                ...
                ('picture', models.ImageField(blank=True, null=True, upload_to='shopapp/img', verbose_name='用户头像')),
        ...
        migrations.AddField(
            model_name='store',
            name='type',
            field=models.ManyToManyField(to='ShopApp.StoreType', verbose_name='店铺类型'),
        ),
        migrations.AddField(
            model_name='goods',
            name='store_id',
            field=models.ManyToManyField(to='ShopApp.Store', verbose_name='商品店铺'),
        ),
    ]
